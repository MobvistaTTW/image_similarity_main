...
from similarity_data import create_datasets
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(EPOCHS)):
        #训练
        train_loss=train_one_epoch(encoder=encoder,decoder=decoder,trian_loader=train_loader,loss_fn=loss_fn,optimizer=optimizer,device=device)
        #验证
        val_loss=validate(encoder=encoder,decoder=decoder,val_loader=val_loader,loss_fn=loss_fn,device=device)
